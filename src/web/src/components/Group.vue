<template>
  <div class="w-full flex justify-center">
    <div class="flex flex-col h-full px-[1rem] py-[1rem] space-y-[1rem]">
      <el-dialog v-model="showCreate" top="5vh" title="Create Group" width="50%">
        ...
        <template #footer>
          <span class="dialog-footer">
            <el-button color="#092B2C" style="color: white" @click="createGroup">Confirm</el-button>
      ...
      <el-dialog v-model="showUpdate" top="5vh" title="Update Group" width="50%">
        ...
        <template #footer>
          <span class="dialog-footer">
            <el-button color="#092B2C" style="color: white" @click="updateGroup">Confirm</el-button>
      ...
      <el-card class="w-full h-max">
        <template #header>
          <div class="flex justify-between space-x-[2rem]">
            ...
            <el-button color="#092B2C" style="color: white" plain :icon="Peoples" @Click="showCreate = true">Create</el-button>
          </div>
        </template>
          ...
          <el-table-column prop="name" label="Name">
            <template #default="scope">
              <router-link :to="getGroupUrl(scope.row.id)">
                <el-link color="#092B2C" style="color: white">{{ scope.row.name }}</el-link>
              </router-link>
            </template>
          </el-table-column>
